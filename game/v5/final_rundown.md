...
| Aniket Chandra | Startup Investors | Core | Cap Table Mirage - Treasury Interpreter | Convince two strangers to co-sign your theory before Round 3 ends. |
| Anubhav Gaba | Engineering Blackbox | Core | Deploy Syndicate - Incident Decoder | Find a person with opposite personality trait and build a joint claim. |
| Ayush Borse | Culture & Narrative Lab | High-engagement | Story Ops - Context DJ | Find a person with opposite personality trait and build a joint claim. |
| Ayush Mittal | Engineering Blackbox | High-engagement | Log Custodians - Deploy Cartographer | Get one late guest fully onboarded using only your artifact summary. |
| Bharat Dhir | Ops & Ground Truth | Core | Floor Marshals - Floor Marshal | Convince two strangers to co-sign your theory before Round 3 ends. |
| Devashish Rane | Product Council | High-engagement | Backlog Ministry - Narrative PM | Get one late guest fully onboarded using only your artifact summary. |
| Gunjan Samtani | Product Council | High-engagement | Scope Parliament - Scope Arbiter | Turn one rumor into a verifiable statement with witness name. |
| Harsh Bhimrajka | Engineering Blackbox | Core | Signal Engineers - Incident Decoder | Run a 60-second standup with three people outside your team. |
| Iti Kathed | Ops & Ground Truth | Optional | Execution Bureau - Ops Witness | Get one person from your enemy team to admit a timeline doubt. |
| Kartik Khandelwal | Product Council | High-engagement | Feature Tribunal - Decision Historian | Turn one rumor into a verifiable statement with witness name. |
| Kovid Poudel | Engineering Blackbox | Core | Signal Engineers - Auth Sentinel | Get one late guest fully onboarded using only your artifact summary. |
| Mammoth | Ops & Ground Truth | Optional | Execution Bureau - Floor Marshal | Trade one clue only after receiving a signed contradiction. |
| Manasi Chansoria | Ops & Ground Truth | High-engagement | Execution Bureau - Ops Witness | Run a 60-second standup with three people outside your team. |
| Mehul Mohan | Startup Investors | Flexible | Cap Table Mirage - Deal Channel Keeper | Get one person from your enemy team to admit a timeline doubt. |
...
- The Data Scientist's Plus-One (Surabhi Solanki): Shubham Jain's girlfriend. Mission: "Defend Shubham's data models to everyone you meet." | clue: "Shubham told me his model was perfect, but Product forced him to change outputs."
- The Midnight Intern: Unpaid Intern. Mission: "Ask someone for sign-off on a document that doesn't exist." | clue: "I found a shredded paper near the printer at 8:30 PM. It had the word 'Liability' circled."
- The IT Support: Freelance IT Guy. Mission: "Check everyone's phone to ensure they don't have malware." | clue: "The server logs show a massive data wipe initiated from the VIP room at exactly 8:15 PM."
- The Slide-Deck Ghost: Interrupt one team pitch and ask: "show source, not summary." | clue: One hidden appendix page proves a metric was reframed, not improved.
- The Elevator Witness: Appear once in Round 2 and report who switched floors at the wrong time. | clue: Heard a line at 8:47 PM: "If 7:03 leaks, we all go down."
